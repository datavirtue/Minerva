...
public InvoiceItem(AppSettings g, Object[] i){
    this.application = g;
    item = i;
    this.db = application.getDb();
    VAT = DV.parseBool(application.getProps().getProp("VAT"), false);
}
public InvoiceItem(Object[] i, AppSettings application, boolean vat){
...
public static ArrayList getItemList(DefaultTableModel t, AppSettings application, boolean vat){
...
public static ArrayList getItemList(DefaultTableModel t, AppSettings g){
    ArrayList al = new ArrayList(t.getRowCount());
...
public float getItemTotal(){
    ...
    if (isTax1() || isTax2()){
        ...
        InvoiceModel inv = new InvoiceModel(application, this.getInvoiceKey());
...
public float getTax1Total(){
    ...
    if (this.isTax1()){
        ...
        if (VAT) {
            ...
            return Tools.round(InvoiceModel.extractGST(getUnitTotal(), taxRate));
        }else {
