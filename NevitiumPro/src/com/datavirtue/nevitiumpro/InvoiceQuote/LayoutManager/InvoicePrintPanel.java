...
import com.datavirtue.nevitiumpro.Util.PrintPanel;
...
public InvoicePrintPanel(DocumentLayout dl, InvoiceModel inv, int start, int end, double scale) {
        super();
    ...
    public void paint(Graphics g){
        ...
        for (int e = 0; e < elementCount; e++){
            ...
            for (int col = 0; col < tableColumns.size(); col++){
                tc = (TableColumnElement)tableColumns.get(col);
       ...
       /*  Begin: Invoice Items */
        ...
        for (int r = start; r <=end; r++){
            ...
            for (int c = 0; c < cols.size(); c++){
                tc = (TableColumnElement)cols.get(c);
