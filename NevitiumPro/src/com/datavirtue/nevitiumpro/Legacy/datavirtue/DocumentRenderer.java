...
HTMLDocument doc = (HTMLDocument)myJEditorPane.getDocument();
...
*/
  ...
  protected JTextPane jeditorPane;            //Container to hold the
...
*/
  ...
  public DocumentRenderer(Paper paper) {
    pFormat = new PageFormat();
...
*/
  ...
  public void setDocument(javax.swing.JTextPane jedPane) {
