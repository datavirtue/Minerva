...
@NamedQueries({
    @NamedQuery(name = "QuoteItems.findAll", query = "SELECT q FROM QuoteItems q")})
public class QuoteItems implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QuoteItems)) {
            return false;
        }
        QuoteItems other = (QuoteItems) object;
    ...
    public String toString() {
        return "com.datavirtue.nevitiumpro.entities.QuoteItems[ id=" + id + " ]";
    }
