...
import com.datavirtue.nevitiumpro.InvoiceQuote.InvoiceItem;
import com.datavirtue.nevitiumpro.InvoiceQuote.InvoicePayment;
...
public PurchaseHistoryReport(AppSettings application){
...
public void buildReport(){
    ...
    /* Get all of the payments for each day */
        ...
        for (int r = 0; r < temp.getRowCount(); r++){
           ...
           inv = new InvoiceModel(application, (Integer)temp.getValueAt(r, 0));
           ...
           for(int i = 0; i < invoiceItems.size(); i++){
               ...
               ii = (InvoiceItem)invoiceItems.get(i);
...
public void pdfReport(String f){
    PDFReport pdf = new PDFReport(f, "landscape");
