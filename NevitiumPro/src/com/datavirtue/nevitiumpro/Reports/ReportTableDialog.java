...
import com.datavirtue.nevitiumpro.Util.DecimalCellRenderer;
import com.datavirtue.nevitiumpro.Util.Tools;
import com.datavirtue.nevitiumpro.Views.FileDialog;
...
public class ReportTableDialog extends javax.swing.JDialog {
    ...
    public ReportTableDialog(java.awt.Frame parent, boolean modal, AppSettings application, String report) {
        super(parent, modal);
        initComponents();
...
private boolean VAT = false;
    ...
    private void initComponents() {
        ...
        reportTable.setFont(new java.awt.Font("Tahoma", 0, 12));
        ...
        reportTable.setSelectionBackground(new java.awt.Color(204, 255, 255));
        reportTable.setSelectionForeground(new java.awt.Color(0, 0, 0));
        ...
        maxButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Up.png"))); // NOI18N
        ...
        buildButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Next.png"))); // NOI18N
        ...
        printButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Print.png"))); // NOI18N
        ...
        exportButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Export table.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(jLabel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 21, Short.MAX_VALUE)
...
private void setView(){
    ...
    private void export(){
        ...
        FileDialog fd = new FileDialog(null, true, "C:\\", report.getName()+" Export.csv");
        fd.setVisible(true);
    ...
    private void max() {
        ...
        java.awt.Dimension dim = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
                if (!max) {
                    this.setSize(small);
                    maxButton.setIcon(new ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Up.png")));
                }
                    else {
                        dim.setSize(dim.getWidth(), dim.getHeight()-120);
                        this.setSize(dim);
                        maxButton.setIcon(new ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Down.png")));
                    }
