...
import com.datavirtue.nevitiumpro.InvoiceQuote.Quote;
...
import com.datavirtue.nevitiumpro.Legacy.datavirtue.LinePrinter;
import com.datavirtue.nevitiumpro.Legacy.datavirtue.Settings;
import com.datavirtue.nevitiumpro.Legacy.datavirtue.TableBrowseDialog;
import com.datavirtue.nevitiumpro.Reports.ReportDialog;
import com.datavirtue.nevitiumpro.Reports.ReportFactory;
import com.datavirtue.nevitiumpro.Reports.ReportModel;
import com.datavirtue.nevitiumpro.checkMod.*;
...
public class InvoiceDialog extends javax.swing.JDialog {
    ...
    /**
     * This costructor is used to start a new invoice or to load a quote; Specify a zero quoteKey to create a new
     * invoice
     */
    public InvoiceDialog(java.awt.Frame parent, boolean modal, int quoteKey, AppSettings g) {
        ...
        invoiceReportToolbar.add(paymentButton);
        invoiceReportToolbar.add(statementButton);
        invoiceReportToolbar.add(historyButton);

        /*statementButton.setVisible(false);
         paymentButton.setVisible(false);
         historyButton.setVisible(false);*/

        invoiceReportToolbar.setVisible(false);
        ...
        invoice = new InvoiceModel(application);  //blank invoice object
        invoice.setVAT(VAT);
        ...
        ignore_qty = application.getAppGlobalSettings().getPrintZeroAmounts();

        init();
        //voidBox.setVisible(false);

        paymentCheckBox.setSelected(application.getAppUserSettings().getDefaultProcessPayment());

        invoicePrefix = application.getAppUserSettings().getInvoiceNumberPrefix();
        quotePrefix = application.getAppUserSettings().getQuoteNumberPrefix();
        ...
        String c = application.getAppGlobalSettings().getDefaultInvoiceScanField();
    ...
    public InvoiceDialog(java.awt.Frame parent, boolean modal, AppSettings g, int invoice_key) {
    ...
    private void setVAT() {
        ...
        VAT = application.getAppGlobalSettings().getVatSystem();
    }

    private void init() {

        //Version 1.5
        invTable.getColumn(invTable.getColumnName(6)).setHeaderValue(application.getAppGlobalSettings().getTax1Name());
        invTable.getColumn(invTable.getColumnName(7)).setHeaderValue(application.getAppGlobalSettings().getTax2Name());
        t1Label.setText(application.getAppGlobalSettings().getTax1Name());
        t2Label.setText(application.getAppGlobalSettings().getTax2Name());

        pos = application.getAppUserSettings().getPosMode();
        ...
        if (pos) {
            ...
            topInvoicePanel.setVisible(false);
            packingslipButton.setVisible(false);
            shippingButton.setVisible(false);
            printButton.setVisible(false);
        ...
        if (application.getAppGlobalSettings().getShowTax2() == false) {
            t2Field.setVisible(false);
            t2Label.setVisible(false);
        }

        this.VATButton.setVisible(application.getAppGlobalSettings().getVatSystem());
    ...
    private void getInvoice(int key) {
        ...
        invoice = new InvoiceModel(application, key);
        invoice.setVAT(VAT);
        /* Removed 06-02-2011 */
        //invoice.setTaxes(taxRate1, taxRate2);
    ...
    private void getTaxRates() {
        try {
            ...
            taxRate1 = application.getAppGlobalSettings().getTax1Value().floatValue();
        ...
        try {
            ...
            taxRate2 = application.getAppGlobalSettings().getTax2Value().floatValue();
...
//        String currency = application.getAppGlobalSettings().getCurrencySymbol();
...
//        new PrintPreview(invoiceStack, pageSize);
    ...
    private void testprintPDF() {
        ...
        if (rd.isView()) {
            ...
            stat = ReportFactory.veiwPDF(file, application);

        }

        if (rd.getWinPrn()) {

            ReportFactory.windowsFastPrint(file, application);
            if (rd.isDuplicate()) {
                ReportFactory.windowsFastPrint(file, application);
            }
    ...
    private void initComponents() {
        ...
        topInvoicePanel = new javax.swing.JPanel();
        ...
        invoiceSaveToolbar = new javax.swing.JToolBar();
        ...
        topInvoicePanel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        topInvoicePanel.setLayout(new java.awt.GridBagLayout());
        ...
        topInvoicePanel.add(logoPanel, gridBagConstraints);

        billingPanel.setLayout(new java.awt.GridBagLayout());

        copyBillToButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Reports 3d.png"))); // NOI18N
        ...
        billingPanel.add(copyBillToButton, gridBagConstraints);

        custButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Customers.png"))); // NOI18N
        ...
        billingPanel.add(custButton, gridBagConstraints);
        ...
        billingPanel.add(jScrollPane4, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        billingPanel.add(jScrollPane1, gridBagConstraints);

        shipToButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Airplane.png"))); // NOI18N
        ...
        billingPanel.add(shipToButton, gridBagConstraints);

        clearShipToButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Erase.png"))); // NOI18N
        ...
        billingPanel.add(clearShipToButton, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.ipadx = 17;
        billingPanel.add(filler1, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        topInvoicePanel.add(billingPanel, gridBagConstraints);

        controlInfoPanel.setLayout(new java.awt.GridBagLayout());
        ...
        controlInfoPanel.add(invoiceNumberEditCheckBox, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.weightx = 1.0;
        controlInfoPanel.add(datePicker1, gridBagConstraints);

        convertButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Copy document 3d.png"))); // NOI18N
        ...
        controlInfoPanel.add(convertButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.weightx = 1.0;
        controlInfoPanel.add(numberField, gridBagConstraints);
        ...
        controlInfoPanel.add(autoInvoiceNumberButton, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        topInvoicePanel.add(controlInfoPanel, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.ipadx = 18;
        topInvoicePanel.add(filler2, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        getContentPane().add(topInvoicePanel, gridBagConstraints);
        ...
        jPanel5.add(itemTotalField, gridBagConstraints);
        ...
        jPanel5.add(grandTotalField, gridBagConstraints);
        ...
        jPanel5.add(receiptCheckBox, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel5.add(paymentCheckBox, gridBagConstraints);

        calcButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Grid.png"))); // NOI18N
        calcButton.setText("Calculate Prices");
        ...
        jPanel5.add(calcButton, gridBagConstraints);

        invoiceSaveToolbar.setFloatable(false);
        invoiceSaveToolbar.setRollover(true);
        ...
        invoiceSaveToolbar.add(saveButton);

        postButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        postButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Next.png"))); // NOI18N
        ...
        postButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        postButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                postButtonActionPerformed(evt);
            }
        });
        invoiceSaveToolbar.add(postButton);

        closeButton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        closeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Cancel.png"))); // NOI18N
        ...
        invoiceSaveToolbar.add(closeButton);
        ...
        jPanel5.add(invoiceSaveToolbar, gridBagConstraints);
        ...
        summaryPanel.add(jPanel5, gridBagConstraints);

        termsPanel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        termsPanel.add(t1Field, gridBagConstraints);
        ...
        termsPanel.add(t2Field, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(7, 7, 7, 7);
        termsPanel.add(t1Label, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(7, 7, 7, 7);
        termsPanel.add(t2Label, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(7, 7, 7, 7);
        termsPanel.add(datePicker2, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(7, 7, 7, 7);
        termsPanel.add(jLabel1, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridheight = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        termsPanel.add(filler3, gridBagConstraints);

        invoiceReportToolbar.setFloatable(false);
        invoiceReportToolbar.setRollover(true);

        viewReturnsButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Eye.png"))); // NOI18N
        viewReturnsButton.setText("View Returns");
        viewReturnsButton.setToolTipText("Product Returns for this Invoice");
        viewReturnsButton.setFocusable(false);
        viewReturnsButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        viewReturnsButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        viewReturnsButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewReturnsButtonActionPerformed(evt);
            }
        });
        invoiceReportToolbar.add(viewReturnsButton);

        statementButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Period end.png"))); // NOI18N
        statementButton.setText("Statement");
        statementButton.setToolTipText("Detailed Statement of Activity for this Invoice");
        statementButton.setFocusable(false);
        ...
        historyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Case history.png"))); // NOI18N
        ...
        paymentButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Money.png"))); // NOI18N
        ...
        termsPanel.add(invoiceReportToolbar, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.2;
        summaryPanel.add(termsPanel, gridBagConstraints);

        actionPanel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        actionPanel.setLayout(new java.awt.GridBagLayout());

        invoiceActionToolbar.setFloatable(false);
        invoiceActionToolbar.setRollover(true);

        messageButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Get message.png"))); // NOI18N
        ...
        invoiceActionToolbar.add(messageButton);

        printButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Print preview.png"))); // NOI18N
        ...
        invoiceActionToolbar.add(printButton);

        printReceiptButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Form 3d.png"))); // NOI18N
        printReceiptButton.setText("Print Receipt");
        printReceiptButton.setFocusable(false);
        printReceiptButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        invoiceActionToolbar.add(printReceiptButton);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        actionPanel.add(invoiceActionToolbar, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 0.4;
        summaryPanel.add(actionPanel, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        jPanel3.add(summaryPanel, gridBagConstraints);

        itemTablePanel.setLayout(new java.awt.GridBagLayout());

        jToolBar4.setFloatable(false);
        jToolBar4.setRollover(true);

        VATButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Calculator.png"))); // NOI18N
        ...
        shippingButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Balance.png"))); // NOI18N
        ...
        packingslipButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Package.png"))); // NOI18N
        ...
        itemTablePanel.add(jToolBar4, gridBagConstraints);
        ...
        itemTablePanel.add(upcField, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        itemTablePanel.add(qtyTextField, gridBagConstraints);

        jToolBar5.setFloatable(false);
        jToolBar5.setRollover(true);

        miscButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Login.png"))); // NOI18N
        ...
        discountButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Percent.png"))); // NOI18N
        ...
        itemTablePanel.add(jToolBar5, gridBagConstraints);
        ...
        gridBagConstraints.gridwidth = 5;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.ipadx = 862;
        gridBagConstraints.ipady = 93;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        itemTablePanel.add(jScrollPane2, gridBagConstraints);
        ...
        itemTablePanel.add(upcCombo, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel3.add(itemTablePanel, gridBagConstraints);
    ...
    private void processSelectedItems(ArrayList<Inventory> selectedItems) {
//
...
//        }
    ...
    private void scanAction() {
        ...
        ArrayList<Inventory> selectedInventoryItems;

        if (Float.parseFloat(qtyTextField.getText()) <= 0) {
        ...
        if (upcField.getText().trim().equals("")) {   // blank upcField ENTER pressed
            ...
            selectedInventoryItems = id.getSelectedItems();

            if (selectedInventoryItems == null || selectedInventoryItems.isEmpty()) {
                clearFields();
                return;

            }
            processSelectedItems(selectedInventoryItems);
            id.dispose();
            return;
        }

        //value entered into upcField and ENTER pressed
...
//                id.dispose();
    ...
    private void setInvoiceNumber() {
        ...
        nextAutoInvoiceNumber = application.getAppGlobalSettings().getNextInvoiceNumber();
...
//        }
    ...
    private boolean postInvoice(boolean payment) {
        ...
        if (payment) {
            ...
            pd.setVisible(true);
            invoice = new InvoiceModel(application, invoiceKey);
            //paidCheckBox.setSelected(invoice.isPaid());
        }
...
//                ConnectionsAddressDialog csd =
//                        new ConnectionsAddressDialog(parentWin, true,
...
//                }
    ...
    private void doStatement() {
        ...
        if (!application.checkPermissions(user, user.getInvoices(), 500)) {
            return;
        }
    ...
    private void convertToInvoice() {
        ...
        invoice = new InvoiceModel(application);
        invoice.setVAT(VAT);
        invoice.setTaxes(taxRate1, taxRate2);
        ...
        invoice.setShipToKey(theQuote.getShipToKey());
    ...
    private javax.swing.JToolBar invoiceActionToolbar;
    private javax.swing.JCheckBox invoiceNumberEditCheckBox;
    private javax.swing.JToolBar invoiceReportToolbar;
    private javax.swing.JToolBar invoiceSaveToolbar;
    ...
    private javax.swing.JPanel topInvoicePanel;
