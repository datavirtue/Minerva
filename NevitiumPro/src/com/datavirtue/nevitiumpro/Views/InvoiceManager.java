...
public class InvoiceManager extends javax.swing.JDialog {
     ...
     */
    public InvoiceManager(java.awt.Frame parent, boolean modal, AppSettings application) {
    ...
    private void setPayments () {
     ...
     int invKey = (Integer) tm.getValueAt(jTable1.getSelectedRow(),0);
        ...
        InvoiceModel inv = new InvoiceModel(application,invKey);
    ...
    private void initComponents() {
        ...
        newButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Barcode scanner1.png"))); // NOI18N
        ...
        openButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Eye.png"))); // NOI18N
        ...
        payButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Payment.png"))); // NOI18N
        ...
        returnButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Cycle.png"))); // NOI18N
        ...
        closeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Abort.png"))); // NOI18N
        ...
        voidButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Burn document.png"))); // NOI18N
        ...
        statementButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Period end.png"))); // NOI18N
        ...
        historyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Case history.png"))); // NOI18N
        ...
        unpaidRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Red message.png"))); // NOI18N
        ...
        paidRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Green message.png"))); // NOI18N
        ...
        quoteRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Handshake.png"))); // NOI18N
        ...
        voidRadio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Burn document.png"))); // NOI18N
    ...
    private void returnButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnButtonActionPerformed
        ...
        if (!application.checkPermissions(user, user.getInvoiceManager(), 500)){
            return;
        }
        ...
        if (jTable1.getSelectedRow() > -1){
            ...
            InvoiceModel invoice = new InvoiceModel(application, (Integer) tm.getValueAt(the_row, 0));
    ...
    private void closeInvoice(int row) {
        ...
        if (iValue != null && iValue.trim().equalsIgnoreCase("close")){
            ...
            invoice = new InvoiceModel (application, invoice_key);
