...
import com.datavirtue.nevitiumpro.Reports.PDFLabels;
...
public class InventoryLabelsDialog extends javax.swing.JDialog {
    ...
    public InventoryLabelsDialog(java.awt.Frame parent, boolean modal,
            javax.swing.table.TableModel tm, int [] selected_rows, AppSettings g) {
        super(parent, modal);
        initComponents();
    ...
    private void generateLabels() {
        ...
        if (prnRadio.isSelected()){
          ...
          ReportFactory.windowsFastPrint(filename, application);
        ...
        if (!prnRadio.isSelected()){  //print/view
            ...
            ReportFactory.veiwPDF(filename, application);
    ...
    private void initComponents() {
        ...
        labelPanel1 = new com.datavirtue.nevitiumpro.Util.LabelPanel();
        ...
        goButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Play.png"))); // NOI18N
    ...
    private com.datavirtue.nevitiumpro.Util.LabelPanel labelPanel1;
