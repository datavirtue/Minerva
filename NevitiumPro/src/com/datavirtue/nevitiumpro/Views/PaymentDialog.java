...
import com.datavirtue.nevitiumpro.InvoiceQuote.InvoiceModel;
import com.datavirtue.nevitiumpro.Model.GiftCardDAO;
...
public class PaymentDialog extends javax.swing.JDialog {
    ...
    public PaymentDialog(java.awt.Frame parent, boolean modal, int i_key,
        ...
        theInvoice = new InvoiceModel(application, i_key);
    ...
    private boolean postPayment() {
        ...
        if (printCheck) {
            ...
            if (application.checkPermissions(user, user.getChecks(), 500)) {
    ...
    private InvoiceModel theInvoice;
