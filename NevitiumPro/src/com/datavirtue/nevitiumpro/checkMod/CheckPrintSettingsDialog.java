...
package com.datavirtue.nevitiumpro.checkMod;
...
public class CheckPrintSettingsDialog extends javax.swing.JDialog {
   ...
   public static int conv(String s, int def){
    ...
    private void initComponents() {
        ...
        applyButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Floppy.png"))); // NOI18N
        ...
        browseButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Find in folder.png"))); // NOI18N
