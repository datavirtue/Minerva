...
public class CheckDialog extends javax.swing.JDialog {
     ...
     */
    public CheckDialog(java.awt.Frame parent, boolean modal, AppSettings application, int customerKey, float amount, String memo) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/prnchk.gif"))); // NOI18N
        ...
        selectButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-16/enabled/Customers.png"))); // NOI18N
        ...
        printSetupButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/datavirtue/nevitiumpro/res/Aha-24/enabled/Form.png"))); // NOI18N
    ...
    private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goButtonActionPerformed
        ...
        if (addBox.isEnabled() && addBox.isSelected()) {
            printAddress = true;
        }
        ...
        if (printSig) {
            cp.setSignatureImage(props.getProp("SIGPATH"));
        }
